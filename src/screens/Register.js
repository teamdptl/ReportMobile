import gReact, {useEffect, useRef, useState} from "react"
...
const Register =()=>{
    ...
    return(
        ...
        <ImageBackground imageStyle={{opacity: 0.3,backgroundColor : "white"}} style={styles.background} source={require("../assets/image/background-register.jpg")}>
                    <View flex ={1}  marginHorizontal ={35}  marginVertical ={70}>
                        <Ionicons name="arrow-back" size={28} color="black" />
                           <View flex={0.3}>
                                <Heading  size={"2xl"} mb={15} >Đăng ký</Heading>
                                 <Animated.Text style={{opacity:fadeAnim}} size={"sm"} >Nhập các thông tin cần thiết để tiếp tục đăng ký tài khoản</Animated.Text>
                            </View>
